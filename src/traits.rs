use alloy_rpc_types_eth::{
    state::StateOverride, Block, BlockHashOrNumber, FeeHistory, Filter, FilterChanges, Index, Log,
...
pub trait EthApi {
    ...
    async fn block_by_number(
        &self,
        number_or_hash: BlockHashOrNumber,
        full: bool,
    ...
    fn block_uncles_count_by_number(&self, number_or_hash: BlockHashOrNumber) -> RpcResult<U256>;

    /// Returns an uncles at given block and index.
    #[method(name = "eth_getUncleByBlockHashAndIndex")]
    fn uncle_by_block_hash_and_index(&self, hash: H256, index: Index) -> RpcResult<Option<Block>>;
    ...
    async fn balance(
        &self,
        address: H160,
        number_or_hash: Option<BlockHashOrNumber>,
    ) -> RpcResult<U256>;
    ...
    async fn call(
        ...
        number_or_hash: Option<BlockHashOrNumber>,
        state_overrides: Option<BTreeMap<H160, StateOverride>>,
    ) -> RpcResult<Bytes>;
    ...
    async fn fee_history(
        &self,
        block_count: U256,
        newest_block: BlockHashOrNumber,
